    ...
    <section className="relative -mt-[100px] w-full min-h-[90vh] overflow-visible">
      ...
      <div className="absolute top-0 left-0 right-0 h-0 overflow-visible pointer-events-none">
        <div
          ...
          style={{ top: "-73px", width: "110%", transform: "translateX(calc(-50% - 50px))", aspectRatio: "644/171", minHeight: "380px" }}
          aria-hidden
        >
          <img
            src="/7 1.png"
        ...
        <div
          ...
          style={{ top: "-83px", width: "110%", transform: "translateX(calc(-50% - 50px))", aspectRatio: "612/133", minHeight: "380px" }}
          aria-hidden
        >
          <img
            src="/wavy 1.png"
