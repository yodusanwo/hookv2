...
export function RecipesSection({ block }: { block: RecipesBlock }) {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6 md:px-4 pt-12 md:pt-[56px]">
        <SectionHeading
          title={title}
          ...
          theme="light"
        />
        <div className="mt-16 md:grid md:grid-cols-3 md:gap-x-[13px] md:gap-y-[13px]">
          <div className="flex overflow-x-auto overflow-y-hidden gap-4 snap-x snap-mandatory scroll-smooth scrollbar-hide md:contents">
            {recipes.map((r, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ backgroundColor: bgColor }}
                  >
                    <h3 className="recipe-card-title">{r.title ?? "Recipe"}</h3>
                  </div>
                </Link>
              );
            })}
